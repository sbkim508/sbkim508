...
## Experience & Project
- (Jul. 2022 ~ ) 이상탐지 실시간 ~ (추가예정)
- (Oct. 2021 ~ ) 온라인 고객 행동을 반영한 딥러닝 기반 구매 예측과 고객 유형 분류에 관한 연구
- (Oct. 2021 ~ ) 텍스트마이닝을 활용한 고객 경험(Customer Experience) 관점의 신선식품 리뷰 분석
- (Mar. 2022 ~ May. 2022) 전자 DX ~, 삼성글로벌리서치(Samsung Global Research) (추가예정)
- (Sep. 2021 ~ May. 2022) 빅데이터 기반 서비스개발 R&D, "고객의사결정여정(Customer Decision Journey)에 따른 오프라인 구매 행동 데이터 수집 시스템 및 딥러닝 기반 지능형 고객 분석 서비스"
...
## Awards and Honors
- (Jun. 2022) MIS 대학원생 아이디어 공모전 OO상, 한국경영정보학회 (추가예정)
